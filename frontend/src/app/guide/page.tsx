...
const CATEGORIES = [
  ...
  },
  {
    ...
    terms: [
      ...
      {
        term: "Valuasi Intrinsik Benjamin Graham (Graham Number & Formula)",
        badge: "Nilai Intrinsik & Margin of Safety",
        desc: "Metode valuasi fundamental yang diciptakan oleh Benjamin Graham (bapak Value Investing dunia & guru langsung Warren Buffett) untuk mengukur 'harga wajar sejati' (Intrinsic Value) suatu emiten terlepas dari gejolak emosi pasar.\n\n💡 FILOSOFI UTAMA: Pasar saham dalam jangka pendek seperti kontes popularitas (voting machine), tetapi dalam jangka panjang adalah timbangan bobot riil (weighing machine). Harga yang kamu bayar (Price) belum tentu sama dengan nilai yang kamu peroleh (Value).\n\n📐 DUA RUMUS UTAMA BENJAMIN GRAHAM:\n1. Graham Number (Saham Konservatif / Defensive):\n   Graham Value = √(22.5 × EPS × BVPS)\n   • Asal angka 22.5: Batas ideal Graham adalah PER maksimal 15.0x dan PBV maksimal 1.5x (15.0 × 1.5 = 22.5). Bila hasil kali PER × PBV di bawah 22.5, saham dinilai terdiskon secara defensif.\n2. Graham Intrinsic Formula (Saham Bertumbuh / Growth):\n   V* = [EPS × (8.5 + 2g) × 4.4] ÷ Y\n   • 8.5 = PER wajar emiten tanpa pertumbuhan (g=0).\n   • g = estimasi persentase pertumbuhan laba tahunan.\n   • 4.4 = imbal hasil obligasi korporasi berisiko rendah acuan Graham.\n   • Y = suku bunga obligasi acuan saat ini (misal yield SBN 10 tahun).\n\n🛡️ MARGIN OF SAFETY (MoS):\nMoS (%) = [(Nilai Intrinsik - Harga Pasar) ÷ Nilai Intrinsik] × 100%\nIbarat membangun jembatan berkapasitas 10 ton untuk dilewati truk 3 ton — jika analis salah estimasi laba atau ekonomi krisis, modal investor tetap terlindungi.\n\n🎯 REKOMENDASI AKSI PRAKTIS DI IHSG:\n• ZONA BELI EMAS (Undervalued Diskon): Beli saat harga pasar di bawah Graham Number dengan MoS ≥ 20%–30%, diiringi DER < 1.0x (bebas hutang macet) dan ROE > 12% (contoh: SIMP, BBCA saat koreksi).\n• ZONA WAJAR (Hold & Monitor): Jika MoS berada di antara -10% s/d +15%, pertahankan posisi (Hold) sambil menikmati dividen berkala.\n• ZONA OVERVALUED (Take Profit / Rotasi): Jika harga melambung jauh di atas Graham Number (MoS < -25%), bersiap jual bertahap untuk merealisasikan keuntungan dan rotasikan modal ke saham yang masih diskon.\n• WASPADA VALUE TRAP: Jangan membeli saham hanya karena murah (PER/PBV rendah) jika labanya terus anjlok atau hutangnya menumpuk (DER > 3x).",
        example: "Graham Number Rp 1.050, Harga pasar Rp 645 → Diskon Margin of Safety +38.6% (Kategori Deep Value / Undervalued)",
      },
      {
        term: "Current Ratio",
